...
describe("PATCH /api/account/me — update profile", () => {
  it(
    "updates name and returns the updated user",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const app = await buildTestApp();
...
describe("GET /api/account/export — data export", () => {
  it(
    "returns a JSON bundle containing the user and their orgs",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const app = await buildTestApp();
  ...
  it(
    "each org entry contains org, role, and members",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const app = await buildTestApp();
...
describe("DELETE /api/account/me — delete account", () => {
  it(
    "deletes a solo user (no org members) — soft-deletes their org and removes the user",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
  ...
  it(
    "when user is sole owner with other members, reassigns ownership to next eligible member",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const { createDb, schema } = await import("@starter/db");
  ...
  it(
    "user who is only a member (not owner) is removed from org without deleting it",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const { createDb, schema } = await import("@starter/db");
...
describe("DELETE /api/account/orgs/:orgId — delete org", () => {
  it(
    "owner can soft-delete their org",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const { createDb, schema } = await import("@starter/db");
  ...
  it(
    "non-owner member cannot delete the org (403)",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const { createDb, schema } = await import("@starter/db");
  ...
  it(
    "returns 403 when trying to delete an org the user is not a member of",
    async () => {
      const { withTestDb } = await import("@starter/db/test-helpers");
      await withTestDb(async () => {
        const { createDb, schema } = await import("@starter/db");
