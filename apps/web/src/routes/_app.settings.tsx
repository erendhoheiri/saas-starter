    ...
    <div className="p-8 max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Download a JSON bundle of your account data.</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                variant="outline"
              ...
              {exportMutation.isError && (
                <p className="text-destructive text-sm mt-2">Export failed. Please try again.</p>
              )}
            </CardContent>
          </Card>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent>
          ...
          <form onSubmit={handleDeleteSubmit(onDeleteSubmit)} className="space-y-4 mt-2">
            <Input
            ...
            {deleteErrors.confirm && (
              <p className="text-destructive text-sm">{deleteErrors.confirm.message}</p>
            )}
            {deleteAccountMutation.isError && (
              <p className="text-destructive text-sm">Failed to delete account. Please try again.</p>
            )}
            <div className="flex gap-2 justify-end">
              <Button
                type="button"
                variant="outline"
                onClick={() => { setDeleteDialogOpen(false); resetDelete() }}
              >
                Cancel
              </Button>
              <Button
